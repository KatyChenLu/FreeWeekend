...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    _centerNav = [[UINavigationController alloc]initWithRootViewController:mvc];
    
    LeftViewController *leftView = [LeftViewController new];
    MMDrawerController * drawController = [[MMDrawerController alloc]initWithCenterViewController:_centerNav leftDrawerViewController:leftView];
    
    drawController.maximumLeftDrawerWidth = 370;
